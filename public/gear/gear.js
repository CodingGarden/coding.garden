var laptop = [{
  ...
  link: 'https://www.amazon.com/gp/product/B00427OTEU/',
  affiliate_link: 'https://amzn.to/3bGGcwh',
  image: 'https://images-na.ssl-images-amazon.com/images/I/41VSk5L5sFL._AC_.jpg'
}, {
  title: 'Laptop Stand',
  description: 'Sturdy, easily adjustable stand for my macbook. I stand while streaming, so this brings the macbook screen up to my eye level for better ergonomics.',
  ...
  description: 'A matte hard case cover for my macbook pro. I switch out the stickers on my laptop every now and then, and this makes it easy. Also, keeps the macbook nice and shiny underneath.',
...
var lightingCameras = [{
  title: 'Backdrop Support System',
  description: 'Portable support system that holds up my blue screen. Comes with a nice carrying case and clamps.',
  link: 'https://www.amazon.com/gp/product/B072BCNRTY/',
  affiliate_link: 'https://amzn.to/2oyjbne',
  image: 'https://images-na.ssl-images-amazon.com/images/I/61wlrXaGguL._SX679_.jpg'
}, {
  ...
  description: 'I use this for the HD webcam on my desk. Easily adjusts to different viewing angles.',
  ...
  title: 'Lighting Wall and Ceiling Mount',
  description: 'I use these to attach my softbox lights to my ceiling. Initially I just used the stands that came with the softboxes, but these mounts free up a lot of space on the floor.',
  link: 'https://www.amazon.com/gp/product/B07G8P5927/',
  affiliate_link: 'https://amzn.to/2QZI7Cy',
  image: 'https://images-na.ssl-images-amazon.com/images/I/61DrD0gva3L._AC_SX679_.jpg'
}];
...
var microphone = [{
  ...
  title: 'KZ ZS10 Pro',
  description: '5 Driver in-Ear HiFi in ear monitoring headphones. Amazing sound for the price. I wear these to monitor stream alerts, and to monitor playback while making music. The cable is detachable / replaceable.',
  ...
  description: 'Personal in-ear monitor amplifier. This clips to my pocket and allows me to adjust the volume in my headphones without reaching over to the mixer. Not required, but a nice convenience.',
  ...
  title: 'RODE PSA 1',
  description: 'Swivel Mount Studio Microphone Boom Arm. There are less expensive options, but this one is heavy duty and the adjustments are butter smooth. Also, the microphone I have is expensive, so I wanted to protect my investment with a boom arm that will not easily break down / collapse.',
  ...
  description: '8 Core Silver Plated Copper Cable with 3.5mm Plug 2pins. This cable includes a bead that helps the headphones stay in place. The cable is also slightly longer and thicker than the cable that comes with the KZ ZS10 Pros.',
  ...
  title: '25ft 1/4” TRS Cable',
  description: 'This cable goes from the headphone output of the mixer, to the input of the personal in-ear monitor amplifier. This is not a standard instrument cable. Notice the 2 black bars on the plug, this means it carries STEREO sound! A plug with a single black bar will only carry audio to the left channel.',
  ...
  description: 'Allows the USB audio mixer to be plugged in to the streaming computer. The YAMAHA MG10XU I purchased did not include one in the box.',
  ...
  title: '15 FT 1/4” to 3.5 mm Audio Cable',
  description: 'If I\'m not using the personal in-ear monitor, this cable allows me to plug my headphones directly into the mixer.',
  ...
  description: 'I use this cable to send sound from my macbook into the audio mixer. The YAMAHA MG10XU has 2 separate inputs that accept this type of cable. I sometimes use the other RCA input for sound from my phone or any other audio device that has 3.5mm aux out.',
  link: 'https://www.amazon.com/gp/product/B0094A1F3S/',
  affiliate_link: 'https://amzn.to/2GvCREx',
  image: 'https://images-na.ssl-images-amazon.com/images/I/613ExE3gDtL._AC_SX679_.jpg'
}];

var streamingComputer = [{
  title: 'I use this: ABS Fort Gaming Desktop PC',
  description: 'I purchased this pre-built gaming PC on Black Friday in November 2018 for $800. This is a decent mid-tier gaming PC. It is 2 years old, but the specs are more than enough to handle the stream load.',
  specs: [
  ...
  description: 'Full HD 1080P with HDMI and DisplayPort inputs. I use this to monitor the output of OBS and streamlabs alerts.',
  link: 'https://www.amazon.com/gp/product/B071JJ8V4S/',
  affiliate_link: 'https://amzn.to/2QYFAZc',
  image: 'https://images-na.ssl-images-amazon.com/images/I/91TrJ3M5EML._AC_SX679_.jpg'
}, {
  title: 'ErGear Monitor Mount',
  description: 'Full Motion Gas Spring Arm LCD/LED Computer Monitor Riser, Height/Angle Adjustable. Very sturdy and very adjustable monitor stand. This hangs off of my desk and extends out right below the main camera, so I can monitor things while still looking into the camera lense.',
  link: 'https://www.amazon.com/gp/product/B081396DMX/',
  affiliate_link: 'https://amzn.to/3i31iHf',
  ...
  description: 'I use this to control the scenes in OBS. It\'s wireless, so I have it right next to my Coding Laptop. It\'s inexpensive and gets the job done. A streamdeck would be a nice upgrade, but this works well enough for me.',
...
var past = [{
  ...
  affiliate_link: 'https://amzn.to/2MFHfDj',
  image: 'https://images-na.ssl-images-amazon.com/images/I/7131%2Bx9eTGL._SY879_.jpg'
}, {
  title: 'Blue Yeti Shock Mount',
  description: 'Isolates the blue yeti microphone to prevent sound from traveling through the microphone stand.',
  ...
  description: 'A condenser microphone bundle including a microphone arm, pop filter and shock mount. A good starter pack. This combined with the audio filters in OBS will sound good enough.',
  link: 'https://www.amazon.com/gp/product/B07FNGKZ9D/',
  affiliate_link: 'https://amzn.to/2osNkYf',
  image: 'https://images-na.ssl-images-amazon.com/images/I/71mL45kwY0L._SX679_.jpg'
}, {
  title: 'Behringer (UMC204HD) USB Audio Interface',
  description: 'I used this to get the audio signal from the mixer into the streaming computer. You can also plug a condenser microphone directly into it.',
  link: 'https://www.amazon.com/Behringer-UMC204HD-BEHRINGER/dp/B00QHURLCW/',
  affiliate_link: 'https://amzn.to/2ojMnSj',
  image: 'https://images-na.ssl-images-amazon.com/images/I/71O0g8vQ7dL._SX679_.jpg'
}, {
  title: 'Behringer - 12 Input Mixer',
  description: 'I used this to input multiple microphones and other audio sources. I have an older version that does not have USB built in, so I plugged my microphone into this, and plugged this into a USB Audio Interface. If you get this version, you will not need a USB Audio interface, as it has USB built in.',
  link: 'https://www.amazon.com/Behringer-Q1202USB-12-Channel-Mixer/dp/B008O517IW/',
  affiliate_link: 'https://amzn.to/2p5iPIe',
  image: 'https://images-na.ssl-images-amazon.com/images/I/71lRDifM17L._SX679_.jpg'
}, {
  title: 'Logitech HD Pro Webcam C920',
  description: '1080p webcam. I used to use this webcam as my main camera. It works OK as the main camera, but an HD camcorder + capture card looks much better on screen.',
  link: 'https://www.amazon.com/gp/product/B006JH8T3S/',
  affiliate_link: 'https://amzn.to/2Na89CM',
  image: 'https://images-na.ssl-images-amazon.com/images/I/91mie-GfV-L._SX679_.jpg'
}, {
  title: 'Audio-Technica ATH-M30x',
  description: 'Over ear, closed-back headphones. I still use these from time to time when I don\'t feel like using my in ear monitors.',
  link: 'https://www.amazon.com/gp/product/B00HVLUQW8/',
  affiliate_link: 'https://amzn.to/3h4ESUI',
  image: 'https://images-na.ssl-images-amazon.com/images/I/81aZ00ceJOL._AC_SY879_.jpg'
}, {
  title: 'Razer Blade 14" QHD+ Gaming Laptop',
  description: 'My stream setup used to be portable, and this allowed me to stream on the go. I now use a desktop gaming computer instead.',
...
new Vue({
  ...
  data: {
    gear: [{
      ...
      sub_description: 'If you are looking into having a dedicated streaming PC as well, you mainly need a computer with a good amount of RAM, a dedicated video card and at least 3 available USB ports. See the diagram at the very bottom of the page to see how this all hooks up.',
      items: streamingComputer,
    }, {
      title: 'Cameras and Lighting',
      items: lightingCameras,
    }, {
      title: 'Microphone, Audio Mixer and Monitoring',
      items: microphone,
    }, {
      title: 'Past Gear',
